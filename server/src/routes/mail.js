...
//Spam and ham updater
const addToSpam = require('../controllers/addSpam');
const addToHam = require('../controllers/addHam');
router.get('/addtospam', addToSpam);
router.get('/addtoham', addToHam);
